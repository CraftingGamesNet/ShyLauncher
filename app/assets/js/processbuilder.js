...
const { LoggerUtil } = require('shy-core')
const { getMojangOS, isLibraryCompatible, mcVersionAtLeast } = require('shy-core/common')
const { Type } = require('shy-distribution-types')
const os = require('os')
...
class ProcessBuilder {
    ...
    _constructJVMArguments112(mods, tempNativePath) {
        ...
        if (process.platform === 'darwin') {
            args.push('-Xdock:name=ShyLauncher')
                ...
                if (argDiscovery.test(args[i])) {
                    ...
                    switch (identifier) {
                        ...
                        case 'natives_directory':
                            ...
                            break
                        case 'launcher_name':
                            val = args[i].replace(argDiscovery, 'shy-Launcher')
                            break
