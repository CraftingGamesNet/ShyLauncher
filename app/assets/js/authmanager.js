...
const { RestResponseStatus } = require('shy-core/common')
const { MojangRestAPI, MojangErrorCode } = require('shy-core/mojang')
const { MicrosoftAuth, MicrosoftErrorCode } = require('shy-core/microsoft')
